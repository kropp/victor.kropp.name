...
<pre><code class="java">import java.util.prefs.Preferences;
...
<pre><code class="shell nohighlight"><b>$</b> defaults read ~/Library/Preferences/com.apple.java.util.prefs.plist /</code><code>{
    "name/" =     {
        "kropp/" =         {
            "birth_year" = 1986;
...
<pre><code class="shell nohighlight"><b>$</b> cat ~/.java/.userPrefs/name/kropp/site/prefs.xml</code><code>&lt;?xml version="1.0" encoding="UTF-8" standalone="no"?&gt;
...
<pre><code class="shell nohighlight"><b>$</b> ls ~/.java/.userPrefs/name/kropp/       
